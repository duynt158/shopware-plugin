...
namespace EECom\EEComBlog\Core\Content\EEComBlog\Aggregate\EEComBlogTag;
...
class EEComBlogTagDefinition extends MappingEntityDefinition
{
    public const ENTITY_NAME = 'eecom_blog_tag';
