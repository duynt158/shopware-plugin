...
use EECom\EEComBlog\Core\Content\EEComBlog\SearchKeyword\EEComBlogSearchTermInterpreterInterface;
...
class EEComBlogSearchTermInterpreter implements EEComBlogSearchTermInterpreterInterface
{
    /**
     * @var Connection
     */
